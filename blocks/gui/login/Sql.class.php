    ...
    switch ($tipo) {
         ...
         */
       	...
       	case "datosMenu" :
       		...
       		$cadenaSql.=" FROM menu.community_menu_rol_enlace as rol";
       		$cadenaSql.=" INNER JOIN menu.community_menu_enlace AS enl ON enl.id_enlace = rol.id_enlace";
       		$cadenaSql.=" INNER JOIN menu.community_menu_tipo_enlace AS ten ON ten.id_tipo_enlace = enl.id_tipo_enlace";
       		$cadenaSql.=" INNER JOIN menu.community_menu_clase_enlace AS cen ON cen.id_clase_enlace = enl.id_clase_enlace";
       		$cadenaSql.=" WHERE";
