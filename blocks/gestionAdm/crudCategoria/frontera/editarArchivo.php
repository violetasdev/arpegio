<?php
namespace gestionAdm\crudCategoria\frontera;
...
class Registrador
{
    ...
    public function seleccionarForm()
    {
        ...
        $cadenaSql = $this->miSql->getCadenaSql('consultaDetalle',$_REQUEST['id_categoria']);
        $driver = $esteRecursoDB->ejecutarAcceso($cadenaSql, "busqueda");
        $driver=$driver[0];

            $esteCampo = 'Agrupacion';
            $atributos['id'] = $esteCampo;
            $atributos['leyenda'] = 'Editar detalles '. $driver['nombre_categoria'];
            ...
            unset($atributos);
            {
              ...
              $atributos ['placeholder'] = "Escriba nombre de la nueva categoria";
              ...
              if (isset ( $driver [$esteCampo] )) {
                $atributos ['seleccion'] = $driver[$esteCampo];
              } else {
                $atributos ['seleccion'] = 1;
              }
       ...
       */
        ...
        // Paso 1: crear el listado de variables
              ...
              $valorCodificado.= "&opcion=editarCategoria";
              $valorCodificado.= "&id_categoria=".$_REQUEST['id_categoria'];
              $valorCodificado.= "&nombre_categoria_inicial=".$driver['nombre_categoria'];
