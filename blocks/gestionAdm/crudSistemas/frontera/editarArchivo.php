...
class Registrador
{
    ...
    public function seleccionarForm()
    {
        ...
        $cadenaSql = $this->miSql->getCadenaSql('consultaDetalle',$_REQUEST['id_sistema']);
        $driver = $esteRecursoDB->ejecutarAcceso($cadenaSql, "busqueda");
        $driver=$driver[0];

            $esteCampo = 'Agrupacion';
            $atributos['id'] = $esteCampo;
            $atributos['leyenda'] = 'Editar detalles '. $driver['nombre_sistema'];
            ...
            unset($atributos);
            {
              ...
              $atributos ['placeholder'] = "Escriba nombre de la nueva sistema";
       ...
       */
        ...
        // Paso 1: crear el listado de variables
              ...
              $valorCodificado.= "&opcion=editarSistemas";
              $valorCodificado.= "&id_sistema=".$_REQUEST['id_sistema'];
              $valorCodificado.= "&nombre_sistema_inicial=".$driver['nombre_sistema'];
