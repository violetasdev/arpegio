...
class Registrador
{
    ...
    public function seleccionarForm()
    {
        ...
        echo $this->miFormulario->formulario($atributos);
        {
            ...
            $atributos['id'] = $esteCampo;
            $atributos['leyenda'] = 'Crear nuevo sistema operativo';
            ...
            unset($atributos);
            {
              ...
              $atributos ['placeholder'] = "Escriba nombre del nuevo sistema operativo";
              $atributos ['valor'] ='';
       ...
       */
        ...
        // Paso 1: crear el listado de variables
              ...
              $valorCodificado .= "&opcion=registroSistemas";
