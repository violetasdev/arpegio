...
*/
    ...
    function verificarAutenticacionSSO(){
    	...
    	if($this->configurador->getVariableConfiguracion ('OneLogin')==true){
    ...
    function iniciarAutenticacionSSO(){
    	//Si el sistema de logueo es por One Login
    	$resultado = $this->sesionOneLogin->verificarSesion($this->getPagina());
    	return $resultado;
    }
}
?>
